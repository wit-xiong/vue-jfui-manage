<template>
    <el-watermark style="height: 100%;" content="JFUI">
        ...
        <el-breadcrumb separator="/">
            ...
            <el-breadcrumb-item>Alert</el-breadcrumb-item>
        </el-breadcrumb>
        <el-divider />
        <p>Cupertino风格系统弹窗的封装</p>
        <h3>效果</h3>
        <el-row :gutter="5">
            <el-col :span="8">
                <el-image style="height: 667px" :src="Assets.imgAlert1" fit="contain" />
            </el-col>
            <el-col :span="8">
                <el-image style="height: 667px" :src="Assets.imgAlert2" fit="contain" />
            </el-col>
            <el-col :span="8">
                <el-image style="height: 667px" :src="Assets.imgAlert3" fit="contain" />
            </el-col>
        </el-row>
        <h3>代码</h3>
