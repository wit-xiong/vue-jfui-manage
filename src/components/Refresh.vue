<template>
    <el-watermark style="height: 100%;" content="JFUI">
        ...
        <el-row :gutter="5">
            <el-col :span="8">
                <el-image style="height: 667px" src="/src/assets/images/img-refresh1.png" fit="contain" />
            </el-col>
            <el-col :span="8">
                <el-image style="height: 667px" src="/src/assets/images/img-refresh2.png" fit="contain" />
            </el-col>
            <el-col :span="8">
                <el-image style="height: 667px" src="/src/assets/images/img-refresh3.png" fit="contain" />
            </el-col>
        </el-row>
        <h3>代码</h3>
