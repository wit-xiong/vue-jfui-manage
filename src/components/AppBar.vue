<template>
    <el-watermark style="height: 100%;" content="JFUI">
        ...
        <el-breadcrumb separator="/">
            ...
            <el-breadcrumb-item>AppBar</el-breadcrumb-item>
        </el-breadcrumb>
        <el-divider />
        <p>页面顶部导航栏封装，包含Cupertino风格和Material风格</p>
        <h3>效果</h3>
        <el-row :gutter="5">
            <el-col :span="8">
                <el-image style="height: 667px" :src="Assets.imgAppBar1" fit="contain" />
            </el-col>
            <el-col :span="8">
                <el-image style="height: 667px" :src="Assets.imgAppBar2" fit="contain" />
            </el-col>
        </el-row>
        <h3>代码</h3>
